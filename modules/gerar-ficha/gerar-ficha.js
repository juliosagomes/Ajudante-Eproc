...
(async function () {
  ...
  async function extrairDadosProcesso() {
    ...
    const mapaConsulta = {
      ...
      'eproc1g.tjmg.jus.br' : 'https://eproc-consulta-publica-1g.tjmg.jus.br/eproc/externo_controlador.php',
      'eproc2g.tjmg.jus.br' : 'https://eproc-consulta-publica-2g.tjmg.jus.br/eproc/externo_controlador.php',
